...
class Upload_Doc extends Form_Doc {
    ...
    protected function content() {
        ...
        $this->showFormInput('upload_new', 'Upload image: ' , 'input', 'file', '', '', false, $this->_model->getErrorUploadImage(), true, "accept='image/png, image/jpg'");
        ...
        foreach (getCategories($this->_database) as $id => $category) {
            if ($category != 'all'){
