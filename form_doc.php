...
class Form_Doc extends Basic_Doc {
    ...
    protected function showFormStart($page, $classes = '', $width = 12) {
    ...
    protected function showFormInput($id, $label, $element, $type, $value, $pattern, $autofocus, $error, $has_label = true, $extra = '') {
    ...
    protected function showFormEnd($class, $value, $width = 8) {
