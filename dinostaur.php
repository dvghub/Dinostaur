<?php
function showDinostaurContent($data) {
...
function showDetailsContent($data) {
    ...
    echo "<span class='float-left clear-left font-weight-light col-12 col-md-6 font-italic'>".$tags."</span>
    ...
    if (isUserAdmin()) {
        showFormStart('edit');
        showFormInput('product_id', '', 'input', 'hidden', $product['id'], '', false, '', false);
        showFormEnd('col-4 col-md-2 bg-cornflower border-0 text-white height-50 float-right clear-right', 'EDIT', 12);
    }
}
